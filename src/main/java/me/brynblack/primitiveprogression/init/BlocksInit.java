...
import me.brynblack.primitiveprogression.block.*;
...
public class BlocksInit {
  ...
  // rocks
  public static final Block STONE_ROCK_BLOCK,
      ANDESITE_ROCK_BLOCK,
      DIORITE_ROCK_BLOCK,
      GRANITE_ROCK_BLOCK,
  ...
  private static void register(String name, Block block) {
    Registry.register(Registries.BLOCK, Identifier.of("primitiveprogression", name), block);
  }
