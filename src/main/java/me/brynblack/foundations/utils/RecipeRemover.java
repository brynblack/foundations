...
// import me.brynblack.foundations.mixin.MatchingStackAccessor;
// import me.brynblack.foundations.mixin.RecipeFieldAccessor;
...
//           if (!Foundations.CONFIG.crafting.enablePlanksAndSticks) {
...
//             recipeManager,
//             recipe -> {
//               final ItemStack recipeOutput = recipe.getResult();
...
//     Foundations.LOGGER.info("Removed {} recipe(s)", recipesRemoved);
//   }
...
//     Foundations.LOGGER.info("Removed {} plank recipe(s)", recipesRemoved);
//   }
